 ...
 * Plugin URI: 		https://wordpress.org/plugins/javascript-html-text-adder/
 ...
 * Version: 		1.0.1
 * Author: 			WPElite Technology 
 * Author URI:		http://wpelitetech.com/
 * Text Domain:     hja
 * License: GPLv2
 */
...
if( !defined( 'HJA_VERSION' ) ) {
	define( 'HJA_VERSION', '1.0.1' );	
}
if( !defined( 'HJA_AUTHOR' ) ) {
	define( 'HJA_AUTHOR', 'WPElite Technology' );	
}
if( !defined( 'HJA_DIR' ) ) {
